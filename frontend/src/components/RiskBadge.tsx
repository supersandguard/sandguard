...
const config: Record<RiskLevel, { bg: string; text: string; label: string; icon: string }> = {
  green: { bg: 'bg-emerald-500/20', text: 'text-emerald-400', label: 'Seguro', icon: '🟢' },
  yellow: { bg: 'bg-amber-500/20', text: 'text-amber-400', label: 'Precaución', icon: '🟡' },
  red: { bg: 'bg-red-500/20', text: 'text-red-400', label: 'Peligro', icon: '🔴' },
}
